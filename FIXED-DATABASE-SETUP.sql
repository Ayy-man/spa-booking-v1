-- FIXED: Database setup with proper function handling
...
-- 8. Drop existing view and recreate
...
BEGIN
    RAISE NOTICE '==============================================';
    RAISE NOTICE 'FIXED: Database infrastructure created successfully!';
    RAISE NOTICE '==============================================';
    ...
    RAISE NOTICE '- staff_schedule_view';
    RAISE NOTICE '==============================================';
