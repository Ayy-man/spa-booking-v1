-- FINAL WORKING: Database setup with correct column references
...
-- 8. Drop existing view and recreate with CORRECT column references
...
SELECT 
    ...
    b.special_requests,
    b.total_price,
    -- Anonymized customer info with proper type casting
    ...
    -- Timestamps (FIXED: only using columns that exist)
...
BEGIN
    RAISE NOTICE '==============================================';
    RAISE NOTICE 'FINAL WORKING: Database infrastructure created successfully!';
    RAISE NOTICE '==============================================';
    ...
    RAISE NOTICE '- staff_schedule_view (with correct column references)';
    RAISE NOTICE '==============================================';
    RAISE NOTICE 'Ready to run: populate-staff-schedules.js';
    RAISE NOTICE '==============================================';
END $$;